...
You need a legal copy of the latest verson of Fallout 4 through Steam (yes this means the recent update from April 25th), with all DLCs **EXCEPT** the High Definition DLC. This is garbage and should not be used in any case ever.
