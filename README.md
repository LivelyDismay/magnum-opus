...
You need a legal copy of the latest version (yes this means the recent update from April 25th) of Fallout 4 through **Steam** (not GOG, not Epic), with all DLCs **EXCEPT** the High Definition DLC. The High Definition DLC is garbage and should not be used in any case ever.
